  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl px-6 py-10 flex flex-col gap-12">
        {/* Local header to match the provided design */}
        <div className="flex items-center justify-between border-b border-[#223c49] pb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold tracking-tight"><Link href="/dashboard">LevantTalk</Link> - Enhanced LLM</h2>
          </div>
          <nav className="hidden md:flex items-center gap-8 text-sm">
            <a className="text-white/80 hover:text-white" href="#">Home</a>
            <a className="text-white/80 hover:text-white" href="#">Lessons</a>
            <a className="text-white/80 hover:text-white" href="#">Community</a>
            <a className="text-white/80 hover:text-white" href="#">Resources</a>
          </nav>
          <div className="flex gap-2">
            <a
              href="/signup"
              className="h-9 px-4 rounded-md bg-[#0da6f2] text-white text-sm font-semibold hover:bg-[#0a8cd9]"
            >
              Sign up
            </a>
            <a
              href="/login"
              className="h-9 px-4 rounded-md bg-[#223c49] text-white text-sm font-semibold hover:bg-[#2c4c5c]"
            >
              Log in
            </a>
          </div>
